...
class OMDbClient(MetadataClient):
    ...
    async def details(self, provider_id: str) -> MediaMetadata:
        ...
        async with httpx.AsyncClient() as client:
            ...
            return MediaMetadata(
                ...
                media_type=MediaMetadataType.TV_SHOW if data.get("Type") == "series" else MediaMetadataType.MOVIE,
                provider="omdb",
    ...
    async def _fetch_episodes(self, imdb_id: str, total_seasons: int) -> List[TVEpisode]:
