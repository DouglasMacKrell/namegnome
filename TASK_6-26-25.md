...
### 1.7.2 Show Recognition & Metadata Integration ✅ COMPLETED
...
* **Updated Files:**
  ...
  - `src/namegnome/core/tv/anthology/tv_anthology_split.py` - Added confidence routing to all plan item creation sites
